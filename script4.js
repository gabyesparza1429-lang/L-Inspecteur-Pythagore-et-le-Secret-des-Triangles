...
function resetLevel() {
    ...
    // Ocultar calculadora y etiquetas
    ...
    cls(); // Limpiar pantalla calculadora
}
...
function verify() {
    ...
    if(r === misiones[nivel].res) {
        ...
        showMsg("⚠️ OUPS", "Vérifie tes mesures y le calcul.", "#ff7675", false);
    }
}
...
function closeMsg() {
    ...
    if(window.levelWin) { 
        ...
        if(nivel < misiones.length) {
            ...
            alert("Félicitations ! Mission 4 terminée."); 
